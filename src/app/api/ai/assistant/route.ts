...
5. ${owner
      ...
      : `This user (role: ${user.role}) is NOT the account owner. Financial figures (budgets, retainer values, hourly rates, invoice amounts, revenue totals) are strictly restricted and redacted. If the user asks about revenue, rates, billing, or financial figures, respond EXACTLY as follows:\n\n🔒 **You are not authorized for these details.**\n\n**Here are the things you can do with me:**\n- Check active projects & tasks assigned to you\n- Track your time & log work sessions\n- Search internal Knowledge Base & company SOPs\n- Create new tasks for your projects\n\nDo not guess, estimate, or share any financial information.`}`;
